...
<p align="center">
  <a href="https://doi.org/10.5281/zenodo.21807183"><img src="https://img.shields.io/badge/DOI-10.5281%2Fzenodo.21807183-blue?style=flat-square" alt="DOI"></a>
  <a href="https://github.com/tjcadd2020/Asgard-Eukaryote-Phylogenomics-2026"><img src="https://img.shields.io/badge/GitHub-Repository-6B7280?style=flat-square" alt="GitHub"></a>
...
The archaeal origin of eukaryotes remains unresolved. Phylogenomic analyses have placed eukaryotes within or near Lokiarchaeia, Heimdallarchaeia, Hodarchaeales, Njordarchaeales or deeper Asgard branches, often with strong statistical support for mutually incompatible topologies.

This repository supports a study showing that much of this conflict arises from two upstream biases in phylogenomics based on metagenome-assembled genomes (MAGs):
...
| | |
|:--|:--|
| **Topology** | Eukaryotes sister to a monophyletic TACK–Asgard archaeal radiation |
| **Support** | Recovered in **all 12** genome-set × marker-set combinations under full control |
| **Interpretation** | Outside all currently sampled Asgard subgroups |
...
Only simultaneous control of both biases produces a stable placement of eukaryotes. Independent tests (post-hoc contamination audit, expanded taxon sampling, site-heterogeneous PMSF, approximately unbiased topology tests, and ten CAT-GTR chains) support the same relationship. Bayesian chain-level results are summarised descriptively because full convergence was not achieved under CAT-GTR; primary inference is based on contamination-controlled maximum-likelihood analyses and topology tests.
...
| **GS-Zhang2025-B** | Taxonomically balanced version of GS-Zhang2025 | Balanced |
| **GS-Liu2021-B** | Taxonomically balanced version of GS-Liu2021 | Balanced |
...
- Candidate families were examined in **single-protein trees** before concatenation; families with HGT-like or anomalous domain-level clustering were excluded.
...
Composition and overlap: `data/PMS/`.
...
│   └── supplementary_tables/        # Supplementary Tables (.xlsx)
│
└── scripts/
...
The notebook follows the manuscript logic and embeds complete example scripts in order:

| Section | Content | Data location |
|:-------:|:--------|:--------------|
| **A** | Contamination landscape across archaeal MAGs (Fig. 1) | `data/decontamination/assessment/` |
| **B** | Bias-controlled phylogenomics — balancing, four PMSs, ML factorial design, AU, CAT-GTR, post-hoc audit (Figs. 2–3) | `data/genome_sets/` · `data/PMS/` · `data/alignments/` · `data/trees/` |
...
Public isolate genomes and MAGs were obtained from NCBI and the additional sources listed in the genome-list tables. Accession numbers are provided in `data/genome_sets/` and Supplementary Tables 2–6; full raw FASTA assemblies are not re-hosted here and can be retrieved from the public databases using the deposited accession lists.
...
Data and code: https://doi.org/10.5281/zenodo.21807183
```
